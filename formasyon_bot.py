...
# ⏬ Aşağısı önceki gönderdiğim kodun aynısıdır (veri çekme, analiz, mesaj atma vb.)
# ↪ Eğer istersen tam kod bloğunu coin listeli HALLİYLE tekrar aşağıya yapıştırayım.
